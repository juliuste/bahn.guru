	...
	greeting: {
		...
		elements: [
			h('p.description', [
				...
				h('b', 'hoffen, dass bahn.guru und direkt.bahn.guru spätestens Mitte Mai 2025 wieder nutzbar sind (Frohe Ostern! Sorry für die zahlreichen Verzögerungen, aufgrund fehlender Zeit für das Projekt sowie die Komplexität beim Umbau ist eine genaue Einschätzung schwierig.)!'),
			...
			h('p.description', [
				...
				h('b', 'and hope that bahn.guru and direkt.bahn.guru will be back online from the middle of May 2025 (Happy Easter! Sorry about the delays, due to a lack of time for the project and the complexity of changes required, it is hard to make a precise estimation…)!'),
