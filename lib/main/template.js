...
const opengraph = [
		html.meta({name: 'og:title', value: 'bahn.guru - der Bahn-Preiskalender'}),
		html.meta({name: 'og:description', value: 'Der Bahn-Guru hilft dir dabei, die günstigsten Sparpreise der Deutschen Bahn zu finden. 🚅'}),
		html.meta({name: 'og:image', value: 'https://i.imgur.com/bJmvAJp.png'}),
